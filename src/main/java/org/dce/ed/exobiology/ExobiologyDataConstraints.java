    ...
    public static void initConstraints(Map<String, SpeciesConstraint> CONSTRAINTS) {
        ...
        sc.getRules().addAll(Arrays.asList(
            ...
            SpeciesRuleBuilder.create()
                ...
                .pressure(0.006, 1000000.0)
                .atmospheres(AtmosphereType.CO2, AtmosphereType.CO2)
                .volcanism(VolcanismRequirement.VOLCANIC_ONLY)
                .build(),
            SpeciesRuleBuilder.create()
                .gravity(0.025, 0.61)
        ...
        sc.getRules().addAll(Arrays.asList(
            SpeciesRuleBuilder.create()
                .gravity(0.0, 2.0)
                .temperature(0.0, 273.0)
                .pressure(0.0, 1000000.0)
                .atmospheres(AtmosphereType.NONE, AtmosphereType.ARGON, AtmosphereType.ARGON, AtmosphereType.CO2, AtmosphereType.CO2, AtmosphereType.HELIUM, AtmosphereType.METHANE, AtmosphereType.NEON, AtmosphereType.NEON)
        ...
        sc.getRules().addAll(Arrays.asList(
            SpeciesRuleBuilder.create()
                ...
                .temperature(50.0, 150.0)
                .pressure(0.0, 1000000.0)
                .atmospheres(AtmosphereType.ARGON, AtmosphereType.ARGON)
                .planetTypes(PlanetType.ICY)
            ...
            SpeciesRuleBuilder.create()
                ...
                .pressure(0.0, 0.005)
                .atmospheres(AtmosphereType.NEON, AtmosphereType.NEON)
                .planetTypes(PlanetType.ICY)
                .parentStars(Arrays.asList("A", "N", "D", "H", "AeBe"))
                .build()
        ));
        ...
        sc.getRules().addAll(Arrays.asList(
            ...
            SpeciesRuleBuilder.create()
                ...
                .temperature(0.0, 1000000.0)
                .pressure(0.0, 1000000.0)
                .atmospheres(AtmosphereType.AMMONIA, AtmosphereType.ARGON, AtmosphereType.CO2)
                .planetTypes(PlanetType.ICY)
                .volcanism(VolcanismRequirement.VOLCANIC_ONLY)
                .build()
        ));
        ...
        sc.getRules().addAll(Arrays.asList(
            ...
            SpeciesRuleBuilder.create()
                ...
                .pressure(0.0, 1000000.0)
                .atmospheres(AtmosphereType.ARGON, AtmosphereType.ARGON, AtmosphereType.NEON)
                .planetTypes(PlanetType.ICY)
                .volcanism(VolcanismRequirement.VOLCANIC_ONLY)
                .build(),
            SpeciesRuleBuilder.create()
